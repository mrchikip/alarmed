...
class ClockApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Reloj Analogo home AlarMed',
      theme: ThemeData(
...
class ClockPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    var fillBrush = Paint()..color = const Color(0xFF5A948D);
    ...
    var centerFillBrush = Paint()..color = const Color(0xFF404146);
